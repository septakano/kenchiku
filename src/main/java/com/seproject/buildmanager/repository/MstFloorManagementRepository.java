...
public interface MstFloorManagementRepository extends JpaRepository<MstFloorManagement, Integer> {
  ...
  @Query(value = "SELECT " + "    fm.id," + "    fm.customer_id," + "    fm.owner_id,"
      + "    fm.floor_name," + "    fm.post_code," + "    fm.prefectures," + "    fm.address,"
      + "    fm.building_name," + "    fm.phone," + "    fm.mobile_phone," + "    fm.area,"
      + "    fm.status," + "    fm.created_at," + "    fm.updated_at,"
      + "    fm.updated_mst_user_id," + "    c.cust_corp_name AS customer_name,"
  ...
  @Query(
      value = "SELECT fm.id AS id, fm.customer_id, fm.owner_id, fm.floor_name, fm.post_code, fm.prefectures, fm.address, fm.building_name, fm.phone, fm.mobile_phone, fm.area, fm.status, fm.created_at, fm.updated_at, fm.updated_mst_user_id, "
  ...
  @Query(
      value = "SELECT fm.id, fm.customer_id, fm.owner_id, fm.floor_name, fm.post_code, fm.prefectures, fm.address, fm.building_name, fm.phone, fm.mobile_phone, fm.area, fm.status, fm.created_at, fm.updated_at, fm.updated_mst_user_id, c.cust_corp_name AS customer_name, "
