...
@Service
public class MstMaterialsManagementService implements MstSearchService<MstMaterialsManagementForm, MstMaterialsManagementForm> {
  ...
  public MstMaterialsManagement saveMaterialsUpdate(String name, Integer id) {// 変更
    ...
    MstMaterialsManagement a = mstMaterialsRepository.findById(id).orElse(new MstMaterialsManagement());
    MstMaterialsManagement tmp = new MstMaterialsManagement();
    tmp.setId(id);
    tmp.setMaterialsName(name);
    try {
  ...
  public MstMaterialsManagementForm updateMaterialsForm(Integer id) {
    MstMaterialsManagement mstMaterials = mstMaterialsRepository.findById(id).orElse(new MstMaterialsManagement());
  ...
  public List<MstMaterialsManagement> changeMaterialsForm(List<MstMaterialsManagementForm> materialsForm) {
