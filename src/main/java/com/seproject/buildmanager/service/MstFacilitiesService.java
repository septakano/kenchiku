...
public class MstFacilitiesService {
  ...
  private final MstCaseService mstCaseService;
  ...
  public MstFacilitiesService(MstFacilitiesRepository mstFacilitiesRepository,
      ...
      MstFacilitiesDetailRepository mstFacilitiesDetailRepository, MstCaseService mstCaseService) {
  ...
  public MstFacilitiesManagementForm getFaciliriesManagementByCaseId(Integer caseId) {
    ...
    managementForm.setCaseName(this.mstCaseService.getCaseById(caseId).getCaseName());
